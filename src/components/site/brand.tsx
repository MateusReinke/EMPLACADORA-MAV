...
/**
 * Placa Mercosul de motocicleta. Formato próprio: mais alta que larga e com o
 * código em duas linhas — mostrar a placa de carro numa oferta de moto seria
 * vender uma coisa e ilustrar outra.
 */
export const MercosulMotoPlate = ({
  code = "BRA2E19",
  className = "",
  title = "Placa Mercosul de motocicleta emitida pela MAV Emplacamento",
}: {
  code?: string;
  className?: string;
  title?: string;
}) => {
  const top = code.slice(0, 3);
  const bottom = code.slice(3);
  ...
  return (
    ...
    >
      <title>{title}</title>
      <defs>
        <linearGradient id="mav-moto-face" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#FFFFFF" />
          <stop offset="60%" stopColor="#F4F6F9" />
          <stop offset="100%" stopColor="#E3E8EF" />
        </linearGradient>
        <linearGradient id="mav-moto-band" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#1450B4" />
          <stop offset="100%" stopColor="#0A3A8C" />
        </linearGradient>
      </defs>

      <rect width="220" height="190" rx="12" fill="url(#mav-moto-face)" />
      <rect
        x="0.9"
        y="0.9"
        width="218.2"
      ...
      <path d="M0 12a12 12 0 0 1 12-12h196a12 12 0 0 1 12 12v26H0z" fill="url(#mav-moto-band)" />
      <g fill="#FFFFFF">
        <circle cx="14" cy="15" r="1.4" />
        <circle cx="19" cy="13" r="1.4" />
        <circle cx="24" cy="13" r="1.4" />
        <circle cx="29" cy="15" r="1.4" />
      </g>
      <text
        x="21.5"
        y="27"
      ...
      <g transform="translate(180 9)">
        <rect width="28" height="14" rx="1.5" fill="#159A48" />
        <polygon points="14,2 27,7 14,12 1,7" fill="#FFD100" />
        <circle cx="14" cy="7" r="3.6" fill="#0B3B8C" />
      </g>
      ...
      <g transform="translate(10 118)">
        <rect width="26" height="26" rx="2" fill="#FFFFFF" stroke="#0E1524" strokeWidth="0.7" />
        <g fill="#0E1524">
          <rect x="3" y="3" width="7" height="7" />
          <rect x="16" y="3" width="7" height="7" />
          <rect x="3" y="16" width="7" height="7" />
          <rect x="4.8" y="4.8" width="3.4" height="3.4" fill="#FFFFFF" />
          <rect x="17.8" y="4.8" width="3.4" height="3.4" fill="#FFFFFF" />
          <rect x="4.8" y="17.8" width="3.4" height="3.4" fill="#FFFFFF" />
