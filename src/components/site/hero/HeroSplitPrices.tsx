...
import { BUSINESS, PLATE_PRICES, fullAddress, whatsappLink } from "@/content/site";
import { Eyebrow, Stars, WhatsAppIcon } from "../brand";
...
/**
 * OPÇÃO E — headline de valor à esquerda, quadro de preços à direita.
 *
 * Mantém a manchete que sustenta o SEO e a confiança, e coloca ao lado um
 * quadro com os dois preços visíveis de uma vez. Sem slide: quem quer preço
 * lê o quadro, quem quer entender o serviço lê a esquerda.
 */
export const HeroSplitPrices = () => {
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-5 py-12 sm:px-6 lg:grid-cols-[1fr_1fr] lg:gap-12 lg:py-16">
        <div>
          ...
          <ul className="mt-6 grid gap-2.5">
            {["Padrão Mercosul oficial", "Instalação com lacre", "Orçamento fechado no WhatsApp"].map(
              (item) => (
                <li
                  key={item}
        ...
        <div className="relative overflow-hidden rounded-3xl bg-site-contrast p-6 shadow-[0_40px_80px_-36px_rgba(10,31,68,0.8)] sm:p-8">
          ...
          <div className="relative">
            ...
            {/*
              ...
              quebrava o "22% OFF" e o texto dos botões em duas linhas.
            */}
            ...
            <p className="mt-5 font-body text-xs leading-relaxed text-white/50">
              Valor referente à placa Mercosul. Confirme pelo WhatsApp o que está
              incluído no seu caso e as taxas oficiais aplicáveis.
            </p>
          </div>
        </div>
      </div>
