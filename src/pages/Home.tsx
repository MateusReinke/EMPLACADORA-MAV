...
const Home = () => {
  ...
  return (
    <main className="min-h-screen bg-background" itemScope itemType="https://schema.org/ProfessionalService">
      ...
      <section className="reveal-on-scroll relative overflow-hidden py-8 lg:py-24" data-reveal>
        <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-transparent to-primary/5" />
        <div className="container relative grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-6 text-center lg:text-left">
            <div className="mx-auto w-fit rounded-2xl border border-primary/20 bg-background/70 p-3 lg:hidden">
          ...
          <div className="reveal-on-scroll mx-auto hidden w-full max-w-md rounded-3xl border border-primary/20 bg-card/80 p-6 shadow-2xl shadow-primary/20 backdrop-blur lg:block" data-reveal>
